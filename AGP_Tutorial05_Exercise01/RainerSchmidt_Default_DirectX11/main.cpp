...
int						g_iScaleAndColorAmount = 0;
int						g_iRunningValue = 0;
...
HRESULT InitialiseWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	char Name[100] = "Tutorial 05 Exercise 01\0";
...
void RenderFrame(void)
{
	...
	/*// count RunningValue
	g_iRunningValue++;
	OutputDebugString("RunningValue"+g_iRunningValue);
	OutputDebugString("\n");*/
	...
	// create and set XMMatrix
	XMMATRIX projection, world, view;
	world = XMMatrixTranslation(0, 0, 25);
	...
	/*if (g_iRunningValue % 60 == 59)
	{
		OutputDebugString("Constant Buffer!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
		// Set constant buffer
		CONSTANT_BUFFER0 cb0_values;
		cb0_values.ThreeColorAmount = 0.5f * (g_iScaleAndColorAmount % 5);

		g_iScaleAndColorAmount++;
